...
// Helper function to parse numbers with comma/dot support
const parseNumber = (value: string): number => {
  // Replace comma with dot for international format support
...
export function PositionCalculator() {
  ...
  const calculations = useMemo(() => {
    ...
    const riskPercent = parseNumber(riskPerTrade)
    ...
    else if (selectedRR === "Custom") rrMultiplier = parseNumber(customRR) || 2
  ...
  const isPennyStock = parseNumber(entryPrice) > 0 && parseNumber(entryPrice) < 2
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="relative bg-muted rounded-lg p-4 space-y-2">
              ...
              <div className="text-sm text-muted-foreground">
                {formatCurrency(parseNumber(accountBalance))} × {riskPerTrade}%
              </div>
            ...
            <div className="relative bg-muted rounded-lg p-4 space-y-2">
              ...
              <div className="text-sm text-muted-foreground">
                {formatCurrency(parseNumber(entryPrice))} × 2%
              </div>
              <div className="text-xl font-bold text-foreground">
